...
namespace Ork.Framework.Framework.Behaviors
{
  ...
  {
    private static readonly IList<PopupPlacement> popupPlacements = new List<PopupPlacement>(new PopupPlacement[]
                                                                                             {
                                                                                               PopupPlacement.Top, PopupPlacement.Bottom, PopupPlacement.Left, PopupPlacement.Right
                                                                                             });

    private static readonly IList<PopupHorizontalAlignment> horizontalAlignments = new List<PopupHorizontalAlignment>(new PopupHorizontalAlignment[]
                                                                                                                      {
    ...
    private static readonly IList<PopupVerticalAlignment> verticalAlignments = new List<PopupVerticalAlignment>(new PopupVerticalAlignment[]
                                                                                                                {
    ...
    public static readonly DependencyProperty PlacementTargetProperty = DependencyProperty.RegisterAttached("PlacementTarget", typeof (FrameworkElement), typeof (Popup),
      new PropertyMetadata(OnPlacementTargetChanged));

    public static readonly DependencyProperty PlacementParentProperty = DependencyProperty.RegisterAttached("PlacementParent", typeof (FrameworkElement), typeof (Popup), new PropertyMetadata(null));

    public static readonly DependencyProperty PlacementChildProperty = DependencyProperty.RegisterAttached("PlacementChild", typeof (FrameworkElement), typeof (Popup), new PropertyMetadata(null));

    public static readonly DependencyProperty PreferredOrientationsProperty = DependencyProperty.RegisterAttached("PreferredOrientations", typeof (PopupOrientationCollection), typeof (Popup),
      new PropertyMetadata(null));

    public static readonly DependencyProperty ActualOrientationProperty = DependencyProperty.RegisterAttached("ActualOrientation", typeof (PopupOrientation), typeof (Popup), new PropertyMetadata(null));

    public static readonly DependencyProperty StaysOpenProperty = DependencyProperty.RegisterAttached("StaysOpen", typeof (bool), typeof (Popup), new PropertyMetadata(true, OnStaysOpenChanged));

    private static readonly DependencyProperty PopupProperty = DependencyProperty.RegisterAttached("Popup", typeof (System.Windows.Controls.Primitives.Popup), typeof (Popup),
      new PropertyMetadata(null));
    ...
    private static void PositionPopup(System.Windows.Controls.Primitives.Popup popup)
    {
      ...
      var fallbackOrientations = from placement in popupPlacements
                                 ...
                                 where
                                   preferredOrientations.FirstOrDefault(x => x.Placement == placement && x.HorizontalAlignment == horizontalAlignment && x.VerticalAlignment == verticalAlignment) ==
                                   null
                                 select new PopupOrientation()
                                        {
                                          Placement = placement,
      ...
      var orientation = GetPreferredOrientations(popup)
        .FirstOrDefault();
    ...
    private static bool TryPlacePopup(System.Windows.Controls.Primitives.Popup popup, FrameworkElement parent, FrameworkElement placementParent, FrameworkElement placementChild,
      PopupOrientation orientation)
    {
      ...
      if (orientation.Placement == PopupPlacement.Top ||
          orientation.Placement == PopupPlacement.Bottom)
      {
      ...
      if (orientation.Placement == PopupPlacement.Left ||
          orientation.Placement == PopupPlacement.Right)
      {
    ...
    private sealed class PopupWatcher
    {
      ...
      {
        var popupAncestor = FindHighestAncestor(popup);
      ...
      private void OnMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
      {
        ...
        Storyboard.SetTarget(objectAnimation, popup);
