...
using Ork.Framework.PositionDataProvider;
  ...
  public class FullyQualifiedCarViewModel : CarViewModel
  {
    ...
    public string SelectedYear
    {
      ...
      set
      {
        ...
        {
          var car =
            m_FullyQualifiedCars.Single(m => m.Manufacturer == m_SelectedManufacturer && m.Model == m_SelectedModel && m.Description == m_SelectedDescription && m.DateOfChange == m_SelectedYear);
