...
namespace Ork.Framework.CarbonFootprints.Model
{
  ...
  public class PositionDataAccessor
  {
    ...
    public PositionDataAccessor(SettingsProvider settingsProvider)
    {
    ...
    private void Initialize()
    {
      ...
      m_PositionDataContextClient.ClientCredentials.UserName.UserName = m_SettingsProvider.UserName;
